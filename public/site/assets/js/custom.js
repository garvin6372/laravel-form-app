...
function data_overlay() {
  $("[data-overlay-color]").each(function (e) {
    ...
    t.addClass("dsn-overlay-" + e),
      $("body").append(
        "<style>.dsn-overlay-" + e + "[data-overlay]:before{background: " + n + ";}</style>"
      );
  });
}
function background() {
      ...
      (function (n) {
        ...
        return {
          ...
          ajaxNormal: function (t) {
            ...
            i.scrollTop() < r &&
              TweenMax.fromTo(this.main_root, 1, { y: 0 }, { y: -150, ease: Expo.easeIn }),
              TweenMax.to(s, 1, {
                y: 0,
                ease: Expo.easeIn,
                onComplete: function () {
          ...
          slideChange: function (a) {
            ...
            a.on("slideChange", function () {
              ...
              h.staggerFromTo(
                ...
                0,
                function () {
                  t.find(".dsn-slider-content .slide-content").removeClass("dsn-active"),
                    t.find(".dsn-slider-content .slide-content").removeClass("dsn-active-cat"),
            ...
            e.on("setTransition", function (e) {
              ...
              for (let n = 0; n < t.slides.length; n++)
                (t.slides[n].style.transition = e + "ms"),
                  (t.slides[n].querySelector(".image-bg").style.transition = e + "ms");
            });
          },
        ...
        if (
          ...
          e(".scroll-to").on("click", function (t) {
            ...
            r.isScroller(!0) && (n = r.getScrollbar()),
              TweenLite.to(n, 1.5, { scrollTo: e(".wrapper").offset().top, ease: Expo.easeInOut });
          }),
          !this.isScroller(!0))
        )
          return;
    ...
    (function () {
      ...
      e(".site-header .custom-drop-down > a").on("click", function () {
        ...
        i.on("scroll", function () {
          ...
          void 0 !== a && (o = a.top),
            t > o
              ? (n.addClass("header-stickytop"), e(".sections").addClass("body-pt"))
              : (n.removeClass("header-stickytop"), e("body").css("paddingTop", 0));
        });
      ...
      return {
        ...
        headerProject: function () {
          ...
          a.hasClass("parallax-move-element") &&
            dsnGrid.parallaxMoveElemnt({ target: e(n), element: a.find(".cover-bg") }, 5, 1);
          ...
          if (
            (i.length > 0 &&
              ...
              d.to(i, 0.8, { force3D: !0, top: "30%", autoAlpha: 0, scale: l }, 0)),
            s.length > 0 &&
              d
                .to(s, 1, { force3D: !0, height: 80 }, 0)
                .to("#dsn-hero-parallax-fill-title h1", 1, { force3D: !0, top: 0 }, 0)
                .to(i.find(".slider-header.slider-header-top"), 1, { force3D: !0, height: 0 }, 0),
            r.length > 0 && d.to(r, 0.8, { force3D: !0, bottom: "-10%", autoAlpha: 0 }, 0),
            d._totalDuration <= 0)
          )
            return !1;
          var c = new ScrollMagic.Scene({ triggerElement: n, triggerHook: 0, duration: "100%" })
            .setTween(d)
            .addTo(t);
          let u = a.find("video");
          return (
        ...
        nextProject: function () {
          let n = e("#dsn-next-parallax-img"),
            ...
            s =
              !(n.length <= 0) &&
              new ScrollMagic.Scene({ triggerElement: a, triggerHook: 1, duration: "100%" })
                .setTween(TweenMax.to(n, 1, { force3D: !0, y: "30%", scale: 1 }, 0))
                .addTo(t),
            l =
              !(i.length <= 0) &&
              new ScrollMagic.Scene({ triggerElement: a, triggerHook: 0.5, duration: "55%" })
                .setTween(
                  TweenMax.to(
                    i,
                    1,
                    { force3D: !0, top: "0%", opacity: 1, ease: Power0.easeNone },
                    0
                  )
                )
                .addTo(t);
          ...
          e('[data-dsn-grid="move-up"]').each(function () {
            ...
            if (a.length > 0) {
              ...
              if (a.hasClass("has-top-bottom")) {
                ...
                1 !== i
                  ? (a.css("top", 0), (s = TweenMax.to(a, 2, { force3D: !0, scale: t, y: e })))
                  : (s = TweenMax.to(a, 1, { force3D: !0, scale: t, y: e, ease: Power0.easeNone }));
              }
        ...
        moveSection: function () {
          e('[data-dsn-grid="move-section"]').each(function () {
            ...
            var c = new ScrollMagic.Scene({ triggerElement: this, triggerHook: o, duration: l })
              .setTween(d)
              .addTo(t);
            r.getListener(function () {
              c.refresh();
        ...
        animateText: function () {
          e('[data-dsn-animate="text"] , [data-dsn-animate="up"]').each(function () {
            ...
            "text" === n.data("dsn-animate")
              ? (dsnGrid.convertTextWord(n, n), n.attr("data-dsn-animate", "animate"))
              : (a = 0.8);
            var i = new ScrollMagic.Scene({ triggerElement: this, reverse: !1, triggerHook: a })
        ...
        headerBlog: function () {
          ...
          if (!(n.length <= 0 || i.width() < 992)) {
            var a = new ScrollMagic.Scene({
              ...
              .setTween(TweenMax.fromTo(n, 1, { width: "100%" }, { width: "80%" }))
              .addTo(t);
            r.getListener(function () {
              a.refresh();
            });
